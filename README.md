...
搜索成功时，普通聊天和 `/search` 都直接输出答案与实际使用的来源，不显示“搜索成功”或“检索完成”。“搜索结果可能不完整或不准确”的专业风险提示只用于医疗、法律、金融、安全等可能影响现实行动的高危请求；普通新闻、比赛、产品和技术搜索不显示该提示。搜索失败时仍会明确披露“在线检索未完成”或“无法完成在线核验”。
